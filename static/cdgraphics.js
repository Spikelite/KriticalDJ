/*! cdgraphics v7.0.0 -- CD+G (karaoke graphics) decoder/renderer
 *  (c) bhj (github.com/bhj/cdgraphics) -- ISC License
 *  https://www.npmjs.com/package/cdgraphics (vendored from unpkg, ESM export
 *  replaced with a window.CDGraphics global for offline <script> use)
 *  API: const c = new CDGraphics(arrayBuffer); c.render(seconds) ->
 *       { imageData, isChanged, backgroundRGBA, contentBounds }  (300x216)
 */
class p {
  WIDTH = 300;
  HEIGHT = 216;
